...
import { useVerifyFailurePaymentMutation } from '../../services/userApiSlice';
...
const PaymentFailurePage:React.FC = () => {
  ...
  const [ verifyPayment, { isLoading }] = useVerifyFailurePaymentMutation();
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen'>
        ...
        <h1 className='text-2xl'>{`PAYMENT ${paymentDetails?.paymentStatus.toLocaleUpperCase()}`}</h1>
        <div className=''>
